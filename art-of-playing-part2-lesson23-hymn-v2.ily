...
LessonXXIIIUpperC = \relative c''{
	...
	\clef treble
	\repeat volta 2{
		<<{s8 s4.\turn|s8 a4-1 b8-2|s8 s4.\turn}\\
		{b8.^\markup{\finger 2}\( c16^\markup{\finger 1} d^\markup{\finger 2}
			e^\markup{\finger 3} fis^\markup{\finger 4} g^\markup{\finger 5}\)|
		...
		e^\markup{\finger 3} fis^\markup{\finger 4} g^\markup{\finger 5}\)|}\\
		{\hideNotes 
		b,8. \unHideNotes s16 s4|}>>  %added this 3rd voice b/c the MIDI was skipping this note in error
		g'8-5( a,4-1 b8-3)|
...
LessonXXIIILowerC = \relative c {
	...
	\clef bass
	\repeat volta 2{
		g4_\(^\markup{\italic "dolce"} b|d4. b8|a4 d|g,4._\) r8|
		g4_\( b|d4. b8|a4 d|g,4._\) r8|
	}
	\repeat volta 2{
		<<{fis'2-3-2|s4 cis-4-2|d-1 a-2|
	        \hideNotes \ignoreClashNote d,4.-5 \unHideNotes d'8\rest|}\\{d4_\( b^\markup{\finger 5}|
		e^\markup{\finger 1} a,|s2|
		\stemUp	d,4._\) \stemNeutral  %cannot hide this note as it will take the dot away from the note in 1st voice	
		s8|}>>
		g4_\( b|d4. b8|a4 d|g,4._\) r8
	}
}
\score{ % LESSON XXIII: Variat. II PRINT
	  \new PianoStaff <<
