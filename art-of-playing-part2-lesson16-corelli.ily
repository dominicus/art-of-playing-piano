...
LessonXVIUpper = \relative c''{
	...
	\hideTempo
	\repeat volta 2{
		<d f>4.-3-5 <d f>8-3-5 <cis e>4-2-4 r| <f a>4.-3-5 <f a>8 <e g>4-2-4 r|
	%LINE 2
		<<{\stemDown < g bes>4.-3-5 <g bes>8 <f a>4-2-4 <e a~>-2-5 \stemNeutral|
		\ignoreClashNote a4-5 g-4 \ignoreClashNote a2-5|}\\
		  {s1|d,2-1 cis-2|}>>
		<fis a>4.-2-4 <fis a>8 <g bes>4-3-5 r|<e g>4.-2-4 <e g>8 <f a>4-3-5 r|
	%LINE 3
		<d f>4.-1-2 <g bes>8-3-5 <e g>4-1-3 <f a>-2-4|<<{g4.-2-3 g8-1-3 a4-2-4 a|}\\{f4. e8 f4 f|}>>
		r <e g>-2-4 r <d f>-2-4|
	%LINE 4
		<<{b4\rest e-3-5~ e d8-2-4 c-1-3|b4-2-3 b8\rest e-3-5 d4-1-5 c8-1-4 b-3|c4-4 b-2-3 a2-1|}\\
...
LessonXVILower = \relative c'{
	...
	%LINE 4
		...
		e8-1 a,-4  e'-1 e,-5 a2^\markup{\finger "3-5"}|
	}
	\repeat volta 2{
...
\score{ % LESSON XVI: Allemnade de Corelli  PRINT
	  \new PianoStaff <<
...
\score{ % LESSON XVI: Allemnade de Corelli MIDI-24
	\unfoldRepeats
	  \new PianoStaff <<
		    \new Staff = "upper" \LessonXVIUpper
		    \new Staff = "lower" \LessonXVILower
